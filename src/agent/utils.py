...
def create_podcast_discussion(
    ...
    script_prompt = f"""
    Create a natural, engaging podcast conversation between Dr. Sarah (research expert) and {spearker1} (curious interviewer) about "{topic}".
    ...
    tts_prompt = f"TTS the following conversation between {spearker1} and Dr. Sarah:\n{podcast_script}"
